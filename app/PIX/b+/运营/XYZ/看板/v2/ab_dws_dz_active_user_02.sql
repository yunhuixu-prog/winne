...
--215dag
-- drop table if exists airbrush-1324.temp.dws_dz_active_user_02;
-- create table airbrush-1324.temp.dws_dz_active_user_02 as

delete from  `airbrush-1324.temp.dws_dz_active_user_02`  where event_date>='2024-04-30'AND event_date<='2024-06-27';
insert into `airbrush-1324.temp.dws_dz_active_user_02`
with event as (
SELECT
*
FROM
`dataintegration-265403.analytics.dwd_dzp_events_function`('2024-04-30', '2024-06-27', 'airbrush', false)
)
...
case when d.user_pseudo_id is not null then 'Paying' else 'un-Paying' end as is_pay, e.version
from
 (
    ...
    and event_date_hk>='2024-04-30'AND event_date_hk<='2024-06-27'
