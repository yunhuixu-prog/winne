...
--         date_p>='2023-11-17' and date_p<='2023-12-08' --ios时间
        date_p>='2023-12-21' and date_p<='2024-02-01' --android时间
        and cast(ab_code as string) in ('10442','10443',
                                        '10444','10445')
...
(
    ...
    where app_name in ('BeautyPlus')
        and event_date>='2023-12-21' and event_date<='2024-02-01'
        and cast(meepo_abcode as string) in ('10442','10443',
                                        '10444','10445')
...
(
    select m.*
        ,a.code
        ,case
        when a.code in ('10442','10444') then '对照组'
        when a.code in ('10443','10445') then '实验组'
        end as code_type
        ,a.is_new
    from
    (
