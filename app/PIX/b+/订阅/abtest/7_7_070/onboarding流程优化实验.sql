...
--         and case    when platform='IOS' then (event_date between '2024-03-13' and '2024-04-02')
--                     when platform='ANDROID' then (event_date between '2024-03-25' and '2024-04-23')
--                     end
...
(
    ...
    where
        case    when platform='IOS' then (date between '2024-03-13' and '2024-04-02')
                when platform='ANDROID' then (date between '2024-03-25' and '2024-04-23')
                end
...
(
    select distinct
        ...
        ,case   when u.code in ('10537','10534') then '对照组'
                when u.code in ('10538','10535') then '实验组A'
                when u.code in ('10539') then '实验组B'
                end code
        ,case   when source2='OnboardingPage' then 'OnboardingPage'
                else 'others'
                end source
        ,a.sku_type
        ,a.sku_has_trial
