...
(
    select
        a.end_date date,a.order_id,a.original_order_id,a.uuid,a.standard_order_date,a.standard_order_expire_date,a.platform,a.subscription_period,a.sku,a.country
