...
(
    select
          ...
          ,case when date between '2025-01-28' and '2025-02-03' then '25 春节 2025.01.28 - 2025.02.03'
                when date between '2025-02-13' and '2025-02-17' then '25 情人节 2025.02.13 - 2025.02.17'
                when date between '2025-01-21' and '2025-01-27' then '25 Benchmark 2025.01.21 - 2025.01.27'
                when date between '2024-02-09' and '2024-02-15' then '24 春节 2024.02.09 - 2024.02.15'
    ...
    WHERE
        ((a.date between '2025-01-28' and '2025-02-03') -- 本次春节时间窗口：除夕-初六
    --     or (date between '2025-02-13' and '2025-02-17')  -- 本次七夕活动时间窗口
        or (a.date between '2025-01-21' and '2025-01-27') -- 本次活动Benchmark时间窗口
...
--     a.event_date_hk as date,
    case when event_date_hk between '2025-01-28' and '2025-02-03' then '25 春节 2025.01.28 - 2025.02.03'
        when event_date_hk between '2025-02-13' and '2025-02-17' then '25 情人节 2025.02.13 - 2025.02.17'
        when event_date_hk between '2025-01-21' and '2025-01-27' then '25 Benchmark 2025.01.21 - 2025.01.27'
        when event_date_hk between '2024-02-09' and '2024-02-15' then '24 春节 2024.02.09 - 2024.02.15'
...
where ((a.event_date_hk between '2025-01-28' and '2025-02-03') -- 本次春节时间窗口：除夕-初六
--     or (a.event_date_hk between '2025-02-13' and '2025-02-17')  -- 本次七夕活动时间窗口
        or (a.event_date_hk between '2025-01-21' and '2025-01-27') -- 本次活动Benchmark时间窗口
