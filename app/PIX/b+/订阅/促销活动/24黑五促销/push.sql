...
drop table if exists `dataintegration-265403.temp.black_friday_push_sub_data_temp`;
create table if not exists `dataintegration-265403.temp.black_friday_push_sub_data_temp` as
