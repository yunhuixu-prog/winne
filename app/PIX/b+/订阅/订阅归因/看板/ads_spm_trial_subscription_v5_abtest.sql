delete from `beautyplus-bc0ed.subscription.ads_dzp_subscription_spm_trial_subscription_v5_abtest`  where date >= '{{ (execution_date + macros.timedelta(hours=8) - macros.timedelta(days=15)).strftime("%Y-%m-%d") }}' ;
--delete from `beautyplus-bc0ed.subscription.ads_dzp_subscription_spm_trial_subscription_v5_abtest`  where date >= '2021-01-01' ;
insert into `beautyplus-bc0ed.subscription.ads_dzp_subscription_spm_trial_subscription_v5_abtest`
with
