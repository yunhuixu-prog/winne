drop table if exists `beautyplus-bc0ed.temp.temp_ads_spm_trial_subscription_v5_abtest`;
create table `beautyplus-bc0ed.temp.temp_ads_spm_trial_subscription_v5_abtest` as
...
and u.event_date_hk >=  '2025-02-01'
...
SELECT
    ...
    0 as source_amount_proportion,
      ...
      where a.event_date_hk >= '2025-02-01'
