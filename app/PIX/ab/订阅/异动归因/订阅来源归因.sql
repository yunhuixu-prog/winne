-- 汇总
select event_date
    ,case when event_date between '2025-09-01' and '2025-09-07' then '1:0901~0907'
          when event_date between '2025-09-08' and '2025-09-14' then '2:0908~0914'
    end week
...
where
    event_date between '2025-09-01' and '2025-09-14'
group by
    1,2,3,4,5,6
