...
select date
      ,case when date between '2025-12-01' and '2025-12-07' then '1:20251201～20251207'
            when date between '2025-12-08' and '2025-12-14' then '2:20251208～20251214'
        end date_period
      ,by_period
      ,is_ua
...
--     and (end_date between '2023-12-21' and '2024-01-10' or end_date between '2024-12-21' and '2025-01-10')
    and end_date between '2025-12-01' and '2025-12-14'
)
group by 1,2,3,4
order by 1,2,3,4
