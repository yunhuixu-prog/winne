...
--     ,a.enter_abtest_date
    ...
    ,case when a.source_0 in ('sub_to_guide') then source_module else 'else' end source_0
--     ,case when a.source_0 in ('sub_to_guide') then 'sub_to_guide' else source_module end source_0
