WITH enter AS (
    SELECT
       ...
       event_timestamp
 FROM `dataintegration-265403.analytics.dwd_dzp_events_function`('2025-11-13' ,'2025-12-09','airbrush', false) -- 此处用false 速度会更快
...
,act as (
    ...
    where
        event_date_hk between '2025-11-13' and date_add('2025-12-09',interval 1 day)
...
SELECT
    o.platform,
    o.abcode,
    case when abcode in ('28450') then '对照组'
         when abcode in ('28451') then '实验组A'
         when abcode in ('28452') then '实验组B'
        end code,
    o.event_date_hk,
...
where o.event_date_hk between '2025-11-13' and '2025-12-09'
