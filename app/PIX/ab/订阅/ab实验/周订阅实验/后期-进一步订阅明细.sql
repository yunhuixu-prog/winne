...
where
    ...
    and _table_suffix between'20260107' and '20260203'
   and date(timestamp_micros(event_timestamp),'Asia/Singapore')  between  '2026-01-13' and'2026-02-02'
...
,act as (
    ...
    where
        event_date_hk between '2026-01-13' and '2026-02-02'
...
,paid as (
    ...
    and standard_order_date >= '2026-01-13'
