...
where
    ...
    and func.getParams(event_params,'current_abcode').string_value in  ('11159','11160','11161','11162','11163','11164')
      and _table_suffix between '20250621' and '20250811'
   and date(timestamp_micros(event_timestamp),'Asia/Singapore')  between  '2025-06-22' and'2025-08-10'
)

select first_abcode,count(distinct user_pseudo_id) uv,count(distinct case when code_num>1 then user_pseudo_id end) uv_bigger_then_1
from
(
...
select
    distinct
   date(timestamp_micros(event_timestamp),'Asia/Singapore')  enter_abtest_date, user_pseudo_id, event_name
    ,geo.country country
    ,platform
    ,func.getUserprop(user_properties,'device_id').string_value as device_id
    ,func.getParams(event_params,'current_abcode').string_value as ab_code
...
from `airbrush-1324.analytics_152810936.events_*`
   --- `dataintegration-265403.analytics.dwd_dzp_events_function`('2025-02-28','2025-03-16','airbrush',false)
where
    event_name in ('abcode_enter_test')
    and func.getParams(event_params,'current_abcode').string_value in  ('11159','11160','11161','11162','11163','11164')
      and _table_suffix between '20250621' and '20250811'
   and date(timestamp_micros(event_timestamp),'Asia/Singapore')  between  '2025-06-22' and'2025-08-10'
)
...
select first_abcode,if(code_num>1,1,0) is_bigger_then_1
...
from `dataintegration-265403.analytics.dwd_dzp_events_function`('2025-06-22','2025-08-10','airbrush',false)
where
