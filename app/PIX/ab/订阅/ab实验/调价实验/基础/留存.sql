WITH enter AS (
    SELECT
       ...
       event_timestamp
 FROM `dataintegration-265403.analytics.dwd_dzp_events_function`('2025-06-22' ,'2025-08-17','airbrush', false) -- 此处用false 速度会更快
...
,act as (
    ...
    where
        event_date_hk between '2025-06-22' and date_add('2025-08-17',interval 1 day)
...
where o.event_date_hk between '2025-06-22' and'2025-08-17'
