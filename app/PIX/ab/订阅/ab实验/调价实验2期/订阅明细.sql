...
where
    ...
    and _table_suffix between'20251202' and '20251218'
...
,pay_status as
(
    select distinct event_date,user_pseudo_id,is_paying
    from dataintegration-265403.temp.winne_temp_day_type_2
    where event_date between '2025-12-03' and '2025-12-15'
        and  app_name = 'AirBrush'
)
,enter AS (
-- 取活跃用户中有进入实验的用户
...
left join pay_status p
on a.user_pseudo_id=p.user_pseudo_id and a.date=p.event_date
