...
where
    ...
    and _table_suffix between'20251202' and '20251217'
   and date(timestamp_micros(event_timestamp),'Asia/Singapore')  between  '2025-12-03' and'2025-12-15'
...
,act as (
    ...
    where
        event_date_hk between '2025-12-03' and '2025-12-15'
...
,paid as (
    ...
    and standard_order_date >= '2025-12-03'
...
from (select distinct device_id,code,platform,is_new from enter) a  -- where platform='ANDROID'
left join fe_sub b
on a.device_id=b.device_id
where a.is_new=1
group by 1,2
