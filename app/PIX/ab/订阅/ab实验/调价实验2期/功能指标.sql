...
WHERE
    event_date between '2025-12-03' and '2025-12-13'
...
from `dataintegration-265403.analytics.dwd_dzp_events_function`('2025-12-03','2025-12-13','airbrush',false)
where
...
--    and date(timestamp_micros(event_timestamp),'Asia/Singapore')  between  '2025-12-03' and'2025-12-01'
)
...
select function_level
       ,case when ab_code in ('28522','28525') then '对照组'
         when ab_code in ('28523','28526') then '实验组A'
         when ab_code in ('28524','28527') then '实验组B'
        end code
       ,platform
       ,is_new
