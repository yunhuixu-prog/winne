...
where
    ...
    and _table_suffix between '20251112' and '20251208'
   and date(timestamp_micros(event_timestamp),'Asia/Singapore')  between '2025-11-20' and'2025-12-01'
...
,act as (
    ...
    where
        event_date_hk between '2025-11-20' and'2025-12-01'
...
,paid as (
    ...
    and standard_order_date >= '2025-11-20'
...
--     ,a.enter_abtest_date
    ...
    ,case when a.source_0 in ('hpp') and a.source_1='block_screenshot' then '截屏弹窗'
          when a.source_0 in ('f_hair_dye','f_hairline','f_hairstyles','f_volume','f_hair_texture','f_bangs') then 'Hair'
