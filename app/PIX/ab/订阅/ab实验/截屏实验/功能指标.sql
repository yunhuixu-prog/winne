...
WHERE
    event_date between '2025-11-13' and '2025-12-07'
...
from `dataintegration-265403.analytics.dwd_dzp_events_function`('2025-11-13','2025-12-07','airbrush',false)
where
...
--    and date(timestamp_micros(event_timestamp),'Asia/Singapore')  between  '2025-11-13' and'2025-12-01'
)
...
select function_level
       ,case when ab_code in ('28453') then '对照组'
         when ab_code in ('28454') then '实验组'
        end code
       ,platform,paid_type
