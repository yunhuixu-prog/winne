...
with ads as (
    ...
    and event_date between  '2025-09-09' and '2025-09-21'
   group by 1,2,3
)
,enter_test as (
select
   ...
   ,event_timestamp
from
    `dataintegration-265403.analytics.dwd_dzp_events_function`( '2025-09-09' ,'2025-09-21','airbrush',false)
where
    event_name = 'abcode_enter_test'
    and func.getParams(event_params,'current_abcode').string_value in  ('11402','11403','11404','11405')
)
...
select  case when a.abcode in ('11402','11404') then '对照组'
         when a.abcode in ('11403','11405') then '实验组'
        end code
