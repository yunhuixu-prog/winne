...
WHERE
    event_date between '2025-09-09' and '2025-09-21'
...
from `dataintegration-265403.analytics.dwd_dzp_events_function`('2025-09-09','2025-09-21','airbrush',false)
where
...
where date_diff(date,enter_abtest_date,day)=0 and function_level='1'
