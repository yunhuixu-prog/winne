WITH enter AS (
    SELECT
       ...
       event_timestamp
 FROM `dataintegration-265403.analytics.dwd_dzp_events_function`('2025-09-09' ,'2025-09-21','airbrush', false) -- 此处用false 速度会更快
...
,act as (
    ...
    where
        event_date_hk between '2025-09-09' and date_add('2025-09-21',interval 1 day)
...
SELECT
    o.platform,
    o.abcode,
    case when abcode in ('11402','11404') then '对照组'
         when abcode in ('11403','11405') then '实验组'
        end code,
    o.event_date_hk,
...
where o.event_date_hk between '2025-09-09' and'2025-09-21'
