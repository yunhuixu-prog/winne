...
where
    ...
    and _table_suffix between '20260216' and '20260316'
   and date(timestamp_micros(event_timestamp),'Asia/Singapore')  between '2026-02-17' and'2026-03-15'
...
,act as (
    ...
    where
        event_date_hk between '2026-02-17' and'2026-03-15'
