...
--     ,a.enter_abtest_date
    ...
    ,case when a.source_0 in ('p_onboarding') then 'p_onboarding' else 'else' end source_0
    ,case when a.source_0 in ('p_onboarding') then source_1 else 'else' end source_1
...
--     a.date,
    a.platform
    ,case when ab_code in ('11374','11376') then '对照组'
         when ab_code in ('11375','11377') then '实验组'
        end code
    ,a.ab_code
--     ,a.enter_abtest_date
    -- 付费
