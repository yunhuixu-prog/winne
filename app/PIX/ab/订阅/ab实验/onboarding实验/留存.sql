WITH enter AS (
    SELECT
       ...
       event_timestamp
 FROM `dataintegration-265403.analytics.dwd_dzp_events_function`('2025-08-22' ,'2025-09-10','airbrush', false) -- 此处用false 速度会更快
...
,act as (
    ...
    where
        event_date_hk between '2025-08-22' and date_add('2025-09-10',interval 1 day)
...
SELECT
    o.platform,
    o.abcode,
    case when abcode in ('11369','11372') then '对照组'
         when abcode in ('11371','11373') then '实验组'
        end code,
    o.event_date_hk,
...
where o.event_date_hk between '2025-08-22' and'2025-09-10'
...
SELECT
    o.platform,
    o.abcode,
    case when abcode in ('11374','11376') then '对照组'
         when abcode in ('11375','11377') then '实验组'
        end code,
    o.event_date_hk,
    case when o.is_new = 1 then 'New user' when o.is_new = 0 then 'Old user' end is_new,
--     case when o.enter_new = 1 then 'New user' when o.enter_new = 0 then 'Old user' end is_new,
