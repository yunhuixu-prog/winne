...
where
   ...
   and date(timestamp_micros(event_timestamp),'Asia/Singapore')  between  '2026-02-17' and'2026-03-17'
...
,act as (
    ...
    where
        event_date_hk between '2026-02-17' and '2026-03-17'
...
,paid as (
    ...
    and standard_order_date >= '2026-02-17'
