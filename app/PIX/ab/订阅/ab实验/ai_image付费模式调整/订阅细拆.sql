...
where
   ...
   and date(timestamp_micros(event_timestamp),'Asia/Singapore')  between '2026-02-06' and'2026-03-04'
...
,act as (
    ...
    where
        event_date_hk between '2026-02-06' and'2026-03-04'
...
,paid as (
    ...
    and standard_order_date >= '2026-02-06'
...
--     ,a.source_module
    ,case when a.source_0='ai_filter' then a.source_0 else 'else' end source_0
