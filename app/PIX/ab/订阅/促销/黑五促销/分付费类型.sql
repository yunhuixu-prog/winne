...
(
    ...
    (
        ...
        where
            event_date_hk between '2021-01-01' and '2025-12-08'
    ...
    (
        ...
        where
            app_id = 'AirBrush' and event_date_hk=date_add('2025-12-08',interval 1 day)
    ) h
    ...
    (
        ...
        where event_date_hk=date_add('2025-12-08',interval 1 day)
    ) a
...
--     )t on u.user_pseudo_id = t.user_pseudo_id and u.event_date=t.event_date
    ...
    (
        ...
        and event_date between '2021-01-01' and '2025-12-08'
        group by 1,2
