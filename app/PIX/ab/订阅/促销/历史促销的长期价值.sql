select event_date
    ...
    ,round(sum(bookings_0),2) bookings_0
    ...
    ,round(sum(bookings_366),2) bookings_366
    ,round(sum(renewal_bookings_366),2) renewal_bookings_366
    ,round(sum(return_bookings_366),2) return_bookings_366
    ...
    ,round(sum(bookings_731),2) bookings_731
    ,round(sum(renewal_bookings_731),2) renewal_bookings_731
    ,round(sum(return_bookings_731),2) return_bookings_731
from `dataintegration-265403.temp.winne_temp_sub_add_LTV_value` a
where
    (
    -- 万圣
