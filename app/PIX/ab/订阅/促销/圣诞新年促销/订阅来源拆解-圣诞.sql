drop table if exists `dataintegration-265403.temp.winne_temp_cuxiao_christmas_source`;
create table if not exists `dataintegration-265403.temp.winne_temp_cuxiao_christmas_source` as
...
with eves_pre as (
    ...
    where
        (
            (event_date between '2021-12-22' and '2021-12-28') -- 21，周三-周二
            or (event_date between '2022-12-22' and '2022-12-28') -- 22，周四-周三
            or (event_date between '2023-12-22' and '2023-12-28') -- 23，周五-周四
            or (event_date between '2024-12-22' and '2024-12-28') -- 24，周日-周六
...
(
    select
        event_date,
        case
            when event_date between '2021-12-22' and '2021-12-28' then '21 圣诞'
            when event_date between '2022-12-22' and '2022-12-28' then '22 圣诞'
            when event_date between '2023-12-22' and '2023-12-28' then '23 圣诞'
            when event_date between '2024-12-22' and '2024-12-28' then '24 圣诞'
            when event_date between '2025-12-22' and '2025-12-28' then '25 圣诞'

            when event_date between '2021-12-15' and '2021-12-21' then '21 圣诞Benchmark'
            when event_date between '2022-12-15' and '2022-12-21' then '22 圣诞Benchmark'
            when event_date between '2023-12-15' and '2023-12-21' then '23 圣诞Benchmark'
            when event_date between '2024-12-15' and '2024-12-21' then '24 圣诞Benchmark'
            when event_date between '2025-12-15' and '2025-12-21' then '25 圣诞Benchmark'
        end date_label
        ,platform
        ,is_new,is_ua
    ...
    from dataintegration-265403.temp.winne_temp_cuxiao_christmas_source
    where
        (
            (event_date between '2021-12-22' and '2021-12-28') -- 21，周三-周二
            or (event_date between '2022-12-22' and '2022-12-28') -- 22，周四-周三
    ...
    select
        ...
        ,count(distinct case when event_name ='sub_to_paid' then user_pseudo_id end) sub_success_to_paid_uv
        ,sum(case when event_name = 'sub_to_paid' then payment_price_usd else 0 end) sub_success_to_paid_gmv
    from dataintegration-265403.temp.winne_temp_cuxiao_christmas_source --,unnest(split(source_00,',')) s
    where
        (
            (event_date between '2021-12-22' and '2021-12-28') -- 21，周三-周二
            or (event_date between '2022-12-22' and '2022-12-28') -- 22，周四-周三
