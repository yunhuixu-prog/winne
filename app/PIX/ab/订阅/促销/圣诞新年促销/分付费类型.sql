...
delete from `dataintegration-265403.temp.winne_temp_day_type` where event_date between '2025-12-20' and '2026-01-04';
...
(
    ...
    (
        ...
        where
            event_date_hk between '2025-12-20' and '2026-01-04'
    ...
    (
        ...
        where
            app_id = 'AirBrush' and event_date_hk=date_sub(current_date(),interval 1 day)
    ) h
...
delete from `dataintegration-265403.temp.winne_temp_day_type_2` where event_date between '2025-12-20' and '2026-01-04';
...
--         from `dataintegration-265403.analytics.dwd_dzp_events_function`('2025-12-20','2025-11-02','airbrush',false)
--         where
...
--     )t on u.user_pseudo_id = t.user_pseudo_id and u.event_date=t.event_date
    ...
    (
        ...
        and event_date between '2025-12-20' and '2026-01-04'
        group by 1,2
