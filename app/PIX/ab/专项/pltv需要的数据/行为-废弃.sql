DECLARE mDATE_START DATE DEFAULT '2025-09-01';
DECLARE mDATE_END DATE DEFAULT '2025-09-30';
...
delete from airbrush-1324.temp.dws_dz_pltv_behave where event_date between mDATE_START and mDATE_END;
insert into airbrush-1324.temp.dws_dz_pltv_behave
...
(
    ...
    where
        event_date_hk between mDATE_START and mDATE_END
...
goal_users as
(
    select gu.event_date_hk,gu.user_pseudo_id,uu.uuid
...
(
    ...
    where standard_order_date between mDATE_START and DATE_ADD(mDATE_END,interval 90 day)
