...
delete from `dataintegration-265403.temp.winne_temp_day_type` where event_date between '2025-12-01' and '2025-12-31';
insert into `dataintegration-265403.temp.winne_temp_day_type`
...
(
    ...
    (
        ...
        where
            event_date_hk between '2025-12-01' and '2025-12-31'
    ...
    (
        select
            app_id,uuid,standard_order_date,order_status
             ,case when subscription_period ='lifetime' then date_add('2025-12-31',interval 1 day) else standard_order_expire_date end standard_order_expire_date
        from `dataintegration-265403.dwd.dwd_dap_subscription_trial_subscription_retention_daily`
        where
            app_id = 'AirBrush' and event_date_hk=date_add('2025-12-31',interval 1 day)
    ) h
    ...
    (
        ...
        where event_date_hk=date_add('2025-12-31',interval 1 day)
    ) a
...
delete from `dataintegration-265403.temp.winne_temp_day_type_2` where event_date between '2025-12-01' and '2025-12-31';
insert into `dataintegration-265403.temp.winne_temp_day_type_2`
...
--             ,max(if(t.user_pseudo_id is not null,1,0)) today_sub
            ,max(t1.is_sub_enter) is_sub_enter
            ,max(t1.is_sub_click) is_sub_click
    ...
    (
        ...
        where
            ...
            and event_date_hk=date_add('2025-12-31',interval 1 day)
...
--     )t on u.user_pseudo_id = t.user_pseudo_id and u.event_date=t.event_date
    ...
    (
        select event_date,user_pseudo_id
            ,max(if(event_name = 'w_subscription_enter',1,0)) is_sub_enter
            ,max(if(event_name = 'w_subscription_click',1,0)) is_sub_click
...
--     ,d.today_sub
    ,d.is_sub_enter,d.is_sub_click,d.is_sub,d.is_sub_to_paid,d.is_trial,d.is_trial_to_paid,d.revenue
