...
where
    ...
    and _table_suffix between'20251126' and '20251216'
...
,act as (
    ...
    where
        event_date_hk between '2025-11-27' and '2025-12-15'
...
,paid as (
    ...
    and standard_order_date >= '2025-11-27'
...
--     ,a.enter_abtest_date
    ...
    ,case when a.source_0 in ('f_beautify_auto','f_face') then source_0
          when a.source_0 in ('f_smooth','f_contour','f_foundation','f_concealer','f_wrinkle','f_firm','f_skin_tone','f_details','f_highlighter','f_brighten','f_matte') then 'skin'
