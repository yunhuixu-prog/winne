...
-- create table `dataintegration-265403.roas_dataset_v4.ads_da_new_roas_pre_v4` as
delete from `dataintegration-265403.roas_dataset_v4.ads_da_new_roas_pre_v4` where 1=1;
insert into `dataintegration-265403.roas_dataset_v4.ads_da_new_roas_pre_v4`
with cost as
(
select
    app_id,platform,country,install_date,order_date,amount,
...
cross join
(
   select distinct event_date_hk AS order_date from
...
select
 c.App_Name,c.Platform,c.Country ,c.Attributed_Touch_Date as Date,c.order_date,
...
from
(
SELECT App_Name, Platform, Country, Date as Attributed_Touch_Date, order_date,0.0 as amount,
...
from `dataintegration-265403.roas_dataset_v4.ads_da_new_install_sub_v4`
group by App_Name, Platform, Country, Date, order_date

union all

select
app_id as App_Name,platform as Platform,country as Country,install_date as Attributed_Touch_Date,order_date,amount,
...
group by
 c.App_Name,c.Platform,c.Country,c.Attributed_Touch_Date,c.order_date