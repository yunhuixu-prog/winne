...
delete from `dataintegration-265403.roas_dataset_v4.dwd_da_ua_sub_event_v4` where 1=1;
insert into `dataintegration-265403.roas_dataset_v4.dwd_da_ua_sub_event_v4`
with sub as
(
