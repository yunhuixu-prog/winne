...
-- create table `dataintegration-265403.roas_dataset_v4.dwd_da_new_sub_pre_v4` as
delete from `dataintegration-265403.roas_dataset_v4.dwd_da_new_sub_pre_v4` where 1=1;
insert into `dataintegration-265403.roas_dataset_v4.dwd_da_new_sub_pre_v4`
with  new_sub as (
SELECT
 -- DISTINCT
