-- create table `dataintegration-265403.user_ltv.dws_dz_new_ltv_id`  as
-- 该表需要全量刷新，因为需要计算 LTV ，终身付费
DECLARE start INT64 DEFAULT 0;
delete from `dataintegration-265403.user_ltv.dws_dz_new_ltv_id`
where
...
insert into`dataintegration-265403.user_ltv.dws_dz_new_ltv_id`
