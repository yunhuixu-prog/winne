drop table if exists `beauty-cam-new.temp.dwd_da_save_event_temp`;
create table if not exists `beauty-cam-new.temp.dwd_da_save_event_temp` as
...
(
    ...
    from
        ...
        `dataintegration-265403.analytics.dwd_dzp_events_function`('2023-12-04', '2023-12-19', 'beautypluscam', false) a
...
(
    ...
    where
        ...
        u.event_date_hk>='2023-12-04'
        and u.event_date_hk<='2023-12-19'
)
,
