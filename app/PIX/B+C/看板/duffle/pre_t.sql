...
(select *,   case
    ...
    when country in ('Turkey','Saudi Arabia','Egypt','United Arab Emirates','Lebanon','Kuwait','Qatar','Iran') then 'Middle East'
    else 'general' end as key_country from `beautyplus-bc0ed.duffle.dws_dzp_duffle_dz_material_events_all_function`
...
from
     action_info  a
     left join
     (select module,feature from material_info group by 1,2) b
