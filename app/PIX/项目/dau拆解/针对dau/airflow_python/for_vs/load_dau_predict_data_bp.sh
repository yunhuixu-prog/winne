...
# 提取数据到云端
gsutil rm -r gs://bq2azure-adls/dau_predict_data_bp
bq extract \
--destination_format NEWLINE_DELIMITED_JSON 'temp.dws_dz_dau_split_final_user_behave_extract_batch' \
gs://bq2azure-adls/dau_predict_data_bp/projecsdfsadfa_*.json
rm -rf /home/yunhui/dau/data_bp/predict/*
echo "数据下载，需要等待"
sleep 6
gsutil cp -r gs://bq2azure-adls/dau_predict_data_bp /home/yunhui/dau/data_bp/predict/
gsutil rm -r gs://bq2azure-adls/dau_predict_data_bp
