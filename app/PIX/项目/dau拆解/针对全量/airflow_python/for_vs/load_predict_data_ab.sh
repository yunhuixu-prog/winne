...
# 提取数据到云端
gsutil rm -r gs://bq2azure-adls/predict_data_ab
bq extract \
--destination_format NEWLINE_DELIMITED_JSON 'temp.dws_dz_his_split_final_user_behave_extract_batch' \
gs://bq2azure-adls/predict_data_ab/projecsdfsadfa_*.json
rm -rf /home/yunhui/ab/data/predict/*
echo "数据下载，需要等待"
sleep 6
gsutil cp -r gs://bq2azure-adls/predict_data_ab /home/yunhui/ab/data/predict/
gsutil rm -r gs://bq2azure-adls/predict_data_ab
