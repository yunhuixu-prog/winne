echo "download beautyplus train data"
...
# 提取数据到云端
gsutil rm -r gs://bq2azure-adls/train_data_bp
bq extract \
--destination_format NEWLINE_DELIMITED_JSON 'temp.dws_dz_his_split_final_user_behave_model' \
gs://bq2azure-adls/train_data_bp/projecsdfsadfa_*.json
rm -rf /home/yunhui/bp/data/train/*
echo "数据下载，需要等待"
sleep 6
gsutil cp -r gs://bq2azure-adls/train_data_bp /home/yunhui/bp/data/train/
gsutil rm -r gs://bq2azure-adls/train_data_bp
