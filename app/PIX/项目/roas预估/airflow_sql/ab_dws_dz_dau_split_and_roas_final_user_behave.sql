...
-- drop table if exists airbrush-1324.temp.dws_dz_dau_split_and_roas_final_user_behave;
-- create table airbrush-1324.temp.dws_dz_dau_split_and_roas_final_user_behave as


delete from airbrush-1324.temp.dws_dz_dau_split_and_roas_final_user_behave where date between mDATE_START and mDATE_END;
insert into airbrush-1324.temp.dws_dz_dau_split_and_roas_final_user_behave
