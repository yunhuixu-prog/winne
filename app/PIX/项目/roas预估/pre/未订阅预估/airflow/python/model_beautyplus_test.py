def common_function(ds, **kwargs):
    ...
    def real_predict(stacking,xgbr,evaluate,d,e_d,diff1,diff2):
        ...
        data_pre_real = X_no_sub_now_real.loc[:, ['sub_no_trial_365', 'sub_revenue_365','date', 'Attributed_Touch_Date', 'user_pseudo_id', 'days']]
        ...
        #
        # # beautyplus-bc0ed.temp.ads_dz_roi_predict_sample_evaluate_test
        ...
        # beautyplus-bc0ed.temp.ads_dz_roi_predict_user_predict_sub_revenue_test
