def common_function(ds, **kwargs):
    ...
    def real_predict(stacking, xgbr,d, e_d, diff1, diff2, thred_diff):
        ...
        # airbrush-1324.temp.ads_dz_roi_predict_user_predict_sub_revenue
        ...
        # 删除观测日期近7天数据
        query_delete = """
                delete from airbrush-1324.temp.ads_dz_roi_predict_user_predict_sub_revenue 
    ...
    for diff1 in range(0,3):
        for diff2 in range(0, 53):
            real_predict(stacking, xgbr, d, e_d, diff1, diff2, 0.01)
            gc.collect()
