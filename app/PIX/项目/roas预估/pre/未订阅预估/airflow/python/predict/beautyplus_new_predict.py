def common_function(ds, **kwargs):
    ...
    def model_evaluate(d, e_d, stacking, stacking_, xgbr, thred, thred_diff):
        ...
        del y_no_sub_now,y_no_sub_now_second_predit
        ...
        del data_pre,y_no_sub_now_predit,y_to_regression_predict_revenue_365
    ...
    def real_predict(stacking, xgbr,d, e_d, diff1, diff2, thred_diff):
        ...
        # beautyplus-bc0ed.temp.ads_dz_roi_predict_new_user_predict_sub_revenue
        ...
        # 删除观测日期近7天数据
        query_delete = """
                delete from beautyplus-bc0ed.temp.ads_dz_roi_predict_new_user_predict_sub_revenue 
    ...
    for diff1 in range(0,3):
        for diff2 in range(0, 183):
            real_predict(stacking, xgbr, d, e_d, diff1, diff2, 0.05)
            gc.collect()
