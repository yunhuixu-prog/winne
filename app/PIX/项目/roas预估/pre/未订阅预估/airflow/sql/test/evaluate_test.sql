...
--   where Attributed_Touch_Date between '2023-02-20' and '2023-03-21'
...
--             where types='ua' and sub_now=0 and days>90 and Attributed_Touch_Date between '2023-02-20' and '2023-03-21'
...
--             from beautyplus-bc0ed.temp.ads_dz_roi_predict_user_predict_sub_revenue_test
            from beautyplus-bc0ed.temp.ads_dz_roi_predict_new_user_predict_sub_revenue_test
--             where days=6 and Attributed_Touch_Date between '2023-02-20' and '2023-03-21'
...
--         from beautyplus-bc0ed.temp.ads_dz_roi_predict_user_predict_sub_revenue_test
        from beautyplus-bc0ed.temp.ads_dz_roi_predict_new_user_predict_sub_revenue_test
--         where days<=90 and Attributed_Touch_Date between '2023-02-20' and '2023-03-21'
...
(
    ...
    (
        ...
        (
            select date,Attributed_Touch_Date,days,user_pseudo_id,sub_revenue_365
            from beautyplus-bc0ed.temp.dws_dz_roi_predict_final_model_input_delete_v
--             where types='ua' and sub_now=0 and days>90 and last_active_days>60 and Attributed_Touch_Date between '2023-02-20' and '2023-03-21'
...
--             where days=6 and Attributed_Touch_Date between '2023-02-20' and '2023-03-21'
        ...
        (
            select date,Attributed_Touch_Date,days,user_pseudo_id,sub_revenue_365
            from beautyplus-bc0ed.temp.dws_dz_roi_predict_final_model_input_delete_v
--             where types='ua' and sub_now=0 and (days<=90 or last_active_days<=60) and Attributed_Touch_Date between '2023-02-20' and '2023-03-21'
            where types='new' and sub_now=0 and days<=90 and last_active_days<=60 and Attributed_Touch_Date between '2023-03-19' and '2023-03-21'
        ) a
        join
        (
...
from beautyplus-bc0ed.temp.ads_dz_roi_predict_user_predict_sub_revenue a
join beautyplus-bc0ed.temp.ads_dz_roi_predict_user_predict_sub_revenue_test b
...
--         a.Attributed_Touch_Date,a.date,
        count(1),sum(a.predict_sub_revenue_365) a,sum(b.predict_sub_revenue_365) b
from beautyplus-bc0ed.temp.ads_dz_roi_predict_new_user_predict_sub_revenue a
join beautyplus-bc0ed.temp.ads_dz_roi_predict_new_user_predict_sub_revenue_test b
on a.Attributed_Touch_Date=b.Attributed_Touch_Date and a.date=b.date and a.user_pseudo_id=b.user_pseudo_id
-- group by 1,2

select distinct date from beautyplus-bc0ed.temp.ads_dz_roi_predict_user_predict_sub_revenue
select distinct date from beautyplus-bc0ed.temp.ads_dz_roi_predict_new_user_predict_sub_revenue
