select 
    case when date_p between 20260601 and 20260607 then '第1周'
         when date_p between 20260608 and 20260614 then '第2周'
    end weeks
    ,os_type
    ,country_name
    ,period_type
...
from
        (select   contract_id
            ...
            WHERE date_p=20260614
                    ...
                    and substr(invalid_time,1,8) between 20260601 and 20260614  -- current("yyyyMM01")-1
        )t1
LEFT JOIN (
        -- 解约信息
        SELECT  contract_id
...
group by t1.invalid_date,t1.os_type,t1.country_name,t1.period_type
) t
group by case when date_p between 20260601 and 20260607 then '第1周'
         when date_p between 20260608 and 20260614 then '第2周'
    end
    ,os_type
    ,country_name
