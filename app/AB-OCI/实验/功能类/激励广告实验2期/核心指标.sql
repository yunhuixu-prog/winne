...
from (
    ...
    where
        date_p between 20260618 and 20260629
    ...
    (
        ...
        from (
            ...
            (
                ...
                WHERE date_p BETWEEN 20260618 and 20260629
...
group by a.os_type,case when b.ab_code in ('29021') then '对照组'
        ...
        ,a.duration,case when a.source_0='f_skin_tone' then 'SkinTone' else 'else' end
        -- ,a.date_p,
...
select
    ...
    ,case when a.ab_code in ('29021') then '对照组'
        when a.ab_code in ('29022') then '实验组A'
        when a.ab_code in ('29023') then '实验组B'
        when a.ab_code in ('29024') then '实验组C'
        when a.ab_code in ('29025') then '实验组D'
        end code
    ,a.is_new is_new
