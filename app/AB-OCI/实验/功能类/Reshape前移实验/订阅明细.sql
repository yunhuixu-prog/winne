select
    -- a.date_p,
    a.os_type os_type
    ,case when b.ab_code in ('28822') then '对照组'
        when b.ab_code in ('28823') then '实验组'
        when b.ab_code in ('28824') then '对照组AA'
        end code
...
from (
    ...
    where
        date_p between 20260414 and 20260427
    ...
    (
        ...
        from (
            ...
            (
                ...
                WHERE date_p BETWEEN 20260414 and 20260427
        ...
        join (
            ...
            WHERE date_p between 20260414 and 20260427
                ...
                AND params['current_abcode'] in ('28822','28823','28824')
...
group by a.os_type,case when b.ab_code in ('28822') then '对照组'
        when b.ab_code in ('28823') then '实验组'
        when b.ab_code in ('28824') then '对照组AA'
        end
