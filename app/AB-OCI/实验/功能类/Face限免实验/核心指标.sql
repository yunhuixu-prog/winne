select
    -- a.date_p,
    a.os_type os_type
    ,case when b.ab_code in ('28926','28929') then '对照组'
        when b.ab_code in ('28927','28930') then '实验组A'
        when b.ab_code in ('28928','28931') then '实验组B'
        end code
    ,b.is_new is_new
...
from (
    ...
    where
        date_p between 20260508 and 20260525
    ...
    (
        ...
        from (
            ...
            (
                ...
                WHERE date_p BETWEEN 20260508 and 20260525
...
group by a.os_type,case when b.ab_code in ('28926','28929') then '对照组'
        when b.ab_code in ('28927','28930') then '实验组A'
        when b.ab_code in ('28928','28931') then '实验组B'
...
select
    ...
    ,case when a.ab_code in ('28926','28929') then '对照组'
        when a.ab_code in ('28927','28930') then '实验组A'
        when a.ab_code in ('28928','28931') then '实验组B'
        end code
    ,a.is_new is_new
