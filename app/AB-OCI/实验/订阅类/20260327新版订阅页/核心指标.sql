...
from (
    ...
    where
        date_p between 20260327 and 20260407
...
select
    ...
    ,case when a.ab_code in ('28755','28758') then '对照组'
        when a.ab_code in ('28756','28759') then '实验组A'
        when a.ab_code in ('28757','28760') then '实验组B'
        end code
    ,a.is_new is_new
