select
    -- 
    a.os_type os_type
    ,case when b.ab_code in ('28989','28991') then '对照组'
        when b.ab_code in ('28990','28992') then '实验组A'
      end code
    ,a.date_p date_p
    ,a.duration types
...
from (
    ...
    where
        date_p between 20260609 and 20260630
    ...
    (
        ...
        from (
            ...
            (
                ...
                WHERE date_p BETWEEN 20260609 and 20260630
        ...
        join (
            ...
            WHERE date_p between 20260609 and 20260630
                ...
                AND params['current_abcode'] in ('28989','28990','28991','28992')
...
group by a.os_type,case when b.ab_code in ('28989','28991') then '对照组'
        when b.ab_code in ('28990','28992') then '实验组A'
      end
        ,a.duration
        ,a.date_p