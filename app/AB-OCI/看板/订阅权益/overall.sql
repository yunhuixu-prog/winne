...
insert overwrite table stat_ab.filing_mnz_sub_source_event_whole_level PARTITION(date_p)

select
        '汇总' level,os_type,country,is_new,is_ua,app_version,
        '整体' duration,'整体' sku,'整体' first_source,'整体' second_source,'整体' third_source,'整体' fourth_source,
        sub_enter_uv,
        sub_click_uv,
        sub_suc_uv,
        sub_paid_uv,
...
--         sum(sub_suc_order_uv) sub_suc_order_uv,
    ...
    --         count(distinct case when event_id='sub_suc_order' then gid end) sub_suc_order_uv,
        ...
        group by os_type,country,is_new,is_ua,app_version,date_p
    ) aa
    group by os_type,country,is_new,is_ua,app_version,date_p GROUPING SETS (
        (os_type,country,is_new,is_ua,app_version,date_p),
        -- 5维度
        (os_type, country, is_new, is_ua, date_p),
        (os_type, country, is_new, app_version, date_p),
        (os_type, country, is_ua, app_version, date_p),
        (os_type, is_new, is_ua, app_version, date_p),
        (country, is_new, is_ua, app_version, date_p),
        -- 4维度
        (os_type, country, is_new, date_p),
        (os_type, country, is_ua, date_p),
        (os_type, country, app_version, date_p),
        (os_type, is_new, is_ua, date_p),
        (os_type, is_new, app_version, date_p),
        (os_type, is_ua, app_version, date_p),
        (country, is_new, is_ua, date_p),
        (country, is_new, app_version, date_p),
        (country, is_ua, app_version, date_p),
        (is_new, is_ua, app_version, date_p),
        -- 3维度
        (os_type, country, date_p),
        (os_type, is_new, date_p),
        (os_type, is_ua, date_p),
        (os_type, app_version, date_p),
        (country, is_new, date_p),
        (country, is_ua, date_p),
        (country, app_version, date_p),
        (is_new, is_ua, date_p),
        (is_new, app_version, date_p),
        (is_ua, app_version, date_p),
        -- 2维度
        (os_type, date_p),
        (country, date_p),
        (is_new, date_p),
