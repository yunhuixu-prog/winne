...
insert overwrite table stat_ab.filing_amz_income_monthly PARTITION(date_p)
select
     ...
     ,new_pay_notifyid
     ,renew_notifyid
     ,cast(pay_date as bigint) date_p
from
(
    ...
    (
        ...
        (
            select 'no_refund' type
                ...
                ,period_type
--                 ,pay_date
                ,round(pay_date/100,0)*100+1 pay_date
...
--                 ,refund_date pay_date
                ,round(refund_date/100,0)*100+1 pay_date
