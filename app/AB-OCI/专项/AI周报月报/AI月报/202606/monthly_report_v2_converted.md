...
> - **6/16 业务双周会**，出处：raw `20260616日 业务双周会数据同步`，命中原因：覆盖6月上旬；Makeup 付费密度（pageId=622565821）与版本 V8.9.0 需求链接对齐且正向（实验组打勾渗透+0.44%）；英国新增周度回落因上期含5/25假日窗口——属月内周度对比，**不宜**外推为整月英国新增主因。事件描述：
