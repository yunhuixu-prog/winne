...
> - 整体微跌属正常波动，多国涨跌对冲；
> - **美国**环比-0.21%，属正常波动；**英国**环比+5.04%，主要因渠道新用户环比+62.49%（对该国贡献43%）拉动；**巴西**环比-1.00%，主要因渠道新用户环比-3.51%（对该国贡献45%）、老用户环比-0.61%（对该国贡献47%）拖累，推测六月节高峰后拉美活跃回落，与去年同月环比（-3.14%）同向、今年跌幅更缓；
> - 伊朗环比+211.66%（2.87万 --> 8.93万）活跃冲高，主要因**5/26起伊朗网络逐步恢复**带动回升；德国环比+15.71%（18.88万 --> 21.85万）与土耳其环比+19.56%（12.46万 --> 14.90万）跟涨，反向提拉明显。

## 订阅收入

订阅毛利（剔除退款）为$394.61万，**环比下跌1.42%**（$400.29万 → $394.61万, -$5.69万），**同比上涨14.86%**。其中：

> - **新增毛利**环比-1.71%（贡献62%）是订阅毛利回落主因，其中**美国**新增毛利环比-4.26%（贡献74%）拖累新增盘，推测5月节日窗口后转化自然回落、6月北美修图需求季节性走弱，与去年同月环比（美国新增-14.67%、整体新增-7.37%）同向，今年跌幅更缓；Onboarding、Face 等正向举措部分对冲，未能扭转美国新增走弱。

## 月有效会员数

整体月有效会员数为162.16万，**环比上涨1.01%**（160.53万 → 162.16万, +1.63万），**同比上涨9.14%**。其中：

> - 本月新增订阅会员数9.16万、环比+3.50%（贡献19%），月流失7.53万、环比+7.00%（贡献-30%）拖累加大，本月净新增1.63万较上月1.81万**下降**；净新增走弱与新增毛利回落一致，推测节日窗口后转化放缓；其中**美国**月流失环比+16.97%（贡献-27%）放大流失压力。
...
整体MAU环比-0.07%（6,015,857 --> 6,011,938, -3,919）

> 下钻总结：环比绝对值不足1%，属正常波动，无需下钻归因。总结侧反向提拉中，伊朗MAU环比+211.66%（2.87万→8.93万）与**5/26起伊朗网络逐步恢复**时间重合，作背景说明。
...
订阅毛利（剔除退款，$）环比-1.42%（4,002,914.10 --> 3,946,054.91, -56,859.20）

> 下钻总结：**新增毛利**环比-1.71%（贡献62.06%）为主要拖累，其中**美国新增毛利**环比-4.26%（贡献74.45%）占新增回落主体；相对去年同月环比（整体新增-7.37%、美国新增-14.67%）同向走弱，今年跌幅更缓，兼有节日窗口后回落与季节性因素。Onboarding 实验组（一年约+$26w）、Face 实验组A 等正向实验部分对冲，但未能扭转美国新增走弱。
>
> 知识库命中事件：
>
> - **6/30 业务双周会**，出处：wiki `sources/20260630-biweekly-sync`，命中原因：覆盖分析月末，事件描述：美国新增毛利周度持续下滑、推测6月下旬修图需求淡季；巴西六月节后回落。周度对比窗口仍在6月内，**不可直接**当作整月相对5月的唯一主因，但「进入6月后美国新增持续走弱」与月度美国新增-4.26%方向一致，可作佐证
> - **6/16 业务双周会**，出处：raw `20260616日 业务双周会数据同步`，命中原因：覆盖6月上旬；Makeup 付费密度（pageId=622565821）与版本 V8.9.0 需求链接对齐且正向（实验组打勾渗透+0.44%）；英国新增周度回落因上期含5/25假日窗口——属月内周度对比，**不宜**外推为整月英国新增主因
> - **去年同月环比参照**，出处：`raw_data/bookings.csv`，命中原因：季节性佐证，事件描述：2025-06 相对 2025-05 整体新增-7.37%、美国新增-14.67%，与今年同向
> - **Onboarding 订阅页优化**（V8.10.0，6/8上线，pageId=691207138），出处：实验汇总序号44，命中原因：版本号/实验全称对齐且明显正向，事件描述：实验组一年累积订阅毛利约+$26w——**阻止下降**
> - **Face 子项排序**（V8.11.0，6/17上线，pageId=698128692），出处：实验汇总序号40，命中原因：需求页与「Face子项排序调整」对齐，事件描述：实验组A Face/整体订阅成功 uv 转化 +6%/+4.63%——**阻止下降**
> - **Relight 美意马新增**（6/2），出处：wiki `entities/mark-relight-us-it-my-20260602`，命中原因：分析月内 marks，事件描述：偏活跃/DNU，与美国新增毛利回落方向相反，**订阅侧解释力弱**
>
> 逻辑链：
>
> 导致下降
...
整体月有效会员数环比1.01%（1,605,332 --> 1,621,614, 16,282）
...
> 知识库命中事件：
>
> - **6/30 业务双周会**，出处：wiki `sources/20260630-biweekly-sync`，命中原因：覆盖分析月末，事件描述：美国新增走弱、六月节后巴西活跃回落，与净新增放缓、流失压力方向可对照；周度窗口在月内，作佐证而非唯一主因
> - **巴西六月节 / 圣约翰节**（6/24），出处：wiki `concepts/airbrush-holiday-calendar`，命中原因：分析月整月覆盖六月节窗口，事件描述：巴西活跃冲高后回落，与会员流动结构变化可对照
> - **Onboarding 订阅页优化**（6/8），出处：wiki `sources/onboarding-subscribe-page-ab-v810`，命中原因：分析月内正向订阅实验，事件描述：订阅率显著上涨，与本月新增会员环比+3.50%方向可对照（净新增仍因流失加大而走弱）
> - **V8.10.0 / V8.11.0 版本上线**（6/8、6/17），出处：wiki `sources/2026-versions-index`，命中原因：分析月内发版，事件描述：订阅策略实验并行，或影响新增与流失结构
>
> 逻辑链：
>
> 导致上涨
