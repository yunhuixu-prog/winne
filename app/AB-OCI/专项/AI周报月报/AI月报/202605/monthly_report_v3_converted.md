...
> - 英国 Early May / 春季银行假日（5/4、5/25），出处：wiki `concepts/airbrush-holiday-calendar` + 双周会 `20260519`/`20260602`，命中原因：0525–0531 英 DAU 44.7k（周环比+22.5%）明显高于近几周均值，属冲高非日常，可外推本月英 MAU 上涨；0504–0510 假期周冲高后 0511–0517 回日常，回日常段不作整月下跌解释。事件描述：
> - 美国 Memorial Day（5/25），出处：双周会 `20260602`，命中原因：0525–0531 美 DAU 相对节前周二次抬升（非日常），作月末活跃辅因，主因仍归母亲节窗口。事件描述：
...
!summary2_str!
现象：订阅毛利（剔除退款，$）环比+11.40%（3,593,302 --> 4,002,914, 409,612）
...
> - 2026年母亲节（5/10），出处：wiki `concepts/airbrush-holiday-calendar`，命中原因：节日窗口与北美订阅转化改善时间重合；双周会母亲节周全站订阅日均毛利冲高可外推；去年同月环比订阅毛利+10.54%、新增+12.43%与今年幅度相近，属季节性回暖。事件描述：
