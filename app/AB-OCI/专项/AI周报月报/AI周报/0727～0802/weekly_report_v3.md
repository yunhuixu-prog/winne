...
日均DAU为72.7万，环比+1.44%（71.7万 --> 72.7万, +1.04万）。其中：
...
> - 自然DNU环比+7.36%（2.59万 --> 2.78万, +1,903）（贡献66%），其中俄罗斯自然DNU环比+33.11%（1,752 --> 2,332, +580）（贡献20%）、土耳其自然DNU环比+53.31%（738 --> 1,131, +393）（贡献14%）拉动，推测由于Relight功能带动；
> - 渠道DNU环比+10.29%（0.93万 --> 1.03万, +960）（贡献34%），其中**巴西渠道DNU**环比+70.78%（2,440 --> 4,167, +1,727）（贡献60%）为主要拉动，7月底巴西恢复部分测试 campaign 投放，与补量关停后低基数回升叠加；土耳其渠道DNU环比-50.97%（1,447 --> 710, -738）（贡献-26%）拖累部分涨幅。

## 订阅收入

日均订阅毛利$14.0万，环比-0.74%（$14.1万 --> $14.0万, -$0.10万），属正常波动。
...
> - 渠道新增次留环比+11.64%（12.74% --> 14.22%, +1.48pp）（贡献63%），墨西哥、巴西、土耳其渠道次留上涨居前；
> - 自然新增次留环比+1.96%（17.31% --> 17.65%, +0.34pp）（贡献40%），俄罗斯、土耳其自然新增次留上涨贡献居前，与本周俄、土自然DNU抬升结构同向，关联度：中。
...
整体DAU环比+1.44%（716,673 --> 727,028, +10,355）
...
整体DNU环比+8.13%（35,198 --> 38,061, +2,863）

> 下钻总结：自然环比+7.36%（贡献66.48%），俄罗斯自然环比+33.11%（1,752 --> 2,332, +580）（贡献20.27%）、土耳其自然环比+53.31%（738 --> 1,131, +393）（贡献13.74%）贡献居前，推测由于Relight功能带动；渠道环比+10.29%（贡献33.52%），其中巴西渠道环比+70.78%（2,440 --> 4,167, +1,727）（贡献60.33%）为主要拉动（7月底恢复部分测试 campaign 投放，与补量关停后低基数回升叠加），墨西哥渠道环比-24.82%（1,416 --> 1,064, -352）（贡献-12.28%）与巴墨补量关停一致。
>
> 知识库命中事件：
>
> - 巴墨补量 campaign 陆续关停（marks 20260708），命中原因：墨西哥渠道DNU继续回落与标注一致；关联度：中（墨西哥渠道）
> - 巴西 7 月底恢复部分测试 campaign 投放（知识库 20260728），命中原因：0727～0802 巴西渠道 DNU 大涨与时间重合；与补量关停后低基数可并列；关联度：中（巴西渠道）
>
> 逻辑链：
> 导致上升
> - Relight进入UV抬升 --> 俄罗斯/土耳其自然DNU上涨 --> 自然DNU上涨 --> 整体DNU上涨
> - 巴西测试 campaign 恢复投放 + 关停后低基数 --> 巴西渠道DNU上涨 --> 渠道DNU上涨 --> 整体DNU上涨
>
> 阻止上升
...
└── 渠道，环比10.29%，贡献整体DNU环比8.13%的2.73%（占比33.52%）
    ...
    ├── *拖累* 土耳其，环比-50.97%，贡献-2.10%（-25.77%）
    ├── 法国，环比1265.83%，贡献1.02%（12.57%）
    └── *拖累* 墨西哥，环比-24.82%，贡献-1.00%（-12.28%）
!tree_end!
...
整体活跃次留环比-0.18%（33.12% --> 33.06%, -0.06pp）
...
整体新增次留环比+3.87%（16.10% --> 16.72%, +0.62pp）

> 下钻总结：渠道新增次留环比+11.64%（贡献62.97%），墨西哥（+22.37%）、巴西（+11.59%）、土耳其（+10.26%）渠道次留上涨居前，与本周渠道DNU结构（巴、墨、土）部分同向；自然新增次留环比+1.96%（贡献39.94%），俄罗斯（+12.64%）、土耳其（+19.13%）自然次留上涨贡献，与俄、土自然DNU抬升结构同向（关联度：中），不宜单独归因 Relight。
>
> 逻辑链：
> 导致上升
...
| 渠道新增次留 | 10.60% | 10.70% | 11.09% | 10.19% | 10.59% | 12.59% | 12.74% | 14.22% | +11.64% |
...
整体保存量环比+1.29%（496,735 --> 503,124, +6,390）
...
└── *拖累* 保存率，环比-0.16%，贡献整体保存量环比1.29%的-0.16%（占比-12.23%）
!tree_end!
