...
> - Google BR campaign 误触伊朗 VPN（7/3关停），出处：知识库，命中原因：wk27 Google BR 投放误触使用巴西节点 VPN 的伊朗用户推高伊朗渠道DNU，周五（7/3）关停后本周脉冲回调（非伊朗本地投放变化），事件描述：Google BR campaign 误触伊朗 VPN（7/3关停），关联度：强
> - 美国独立日（7/4），出处：知识库，命中原因：wk27美国自然DNU受独立日出行季拉动冲高，本周为节后首周自然回落，事件描述：美国独立日（7/4），关联度：强
> - Relight 美国 KOL（6.26–7.5），出处：知识库，命中原因：KOL 窗口已于7/5结束，可解释美国自然侧由冲高转入回落的部分背景，但**勿再当作本周主拉动**，事件描述：Relight 美国 KOL（6.26–7.5），关联度：中（窗口结束后回落）
>
!logic_lib_end!
!logic_train_str!
> 逻辑链：
...
> 知识库命中事件：
>
> - Google BR 误触伊朗 VPN（7/3关停）+ 巴西补量 campaign 陆续关停，出处：知识库，命中原因：本周渠道DNU大幅回落，低留存新增占比下降，与新增次留结构抬升同向，事件描述：Google BR 误触伊朗 VPN（7/3关停）+ 巴西补量 campaign 陆续关停，关联度：强
