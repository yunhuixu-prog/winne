...
**路径**: V8.15.0版本（8_19上线）🚩/【P1】功能新增：Airbrush Crop新增「畸变还原」功能（徐娟）
...
| 2026.07.15 | 徐娟 | 创建文档 | 
 ||
| 2026.07.28 | 徐娟 | 畸变还原入口变更 | 
 ||
| 2026.07.30 | 徐娟 | 交互流程图补充 | 
 ||
| 2026.08.10 | 徐娟 | expand上面的New去掉
 | 
 ||
...
- 选择剪裁/旋转/透视/扩图功能打勾后&rarr;进入crop-Undistort：选用剪裁/旋转/透视/扩图功能打勾后图片效果固化，图片作为crop-Undistort输入图，

（如直接从剪裁/旋转/透视/扩图功能**未打勾**点击Undistort，剪裁/旋转/透视/扩图效果不带入Undistort）

- 选择Undistort功能打勾后&rarr;crop-剪裁/旋转/透视/扩图功能：选择Undistort打钩后效果作为crop-剪裁/旋转/透视/扩图功能输入图

（选择Undistort**未打勾**，进入剪裁/旋转/透视/扩图功能，Undistort效果不作为其他功能原图）

- 选择Undistort功能并完成效果**未打勾**&rarr;再进入剪裁/旋转/透视/扩图**未执行操作**&rarr;回到Undistort功能，功能效果有缓存，可选择打勾打叉，
- 如需打勾后想撤销Undistort打钩后效果，需回到一级页面点击
