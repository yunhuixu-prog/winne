...
| **组别 ** | **内容** | 流量 ||
| 对照组ａ（线上） | Chin、Jawline、Jaw Angle、Length、Double Chin、Double Chin Pro、Jaw Shape | 25%
 ||
| 实验组ｂ | Chin、Jawline、**Jawline Pro**、Jaw Angle、Length、Double Chin、Double Chin Pro、Jaw Shape | 25% ||
| 实验组ｂｂ | Chin、Jawline、**Jawline Pro(收合状态）**、Jaw Angle、Length、Double Chin、Double Chin Pro、Jaw Shape | 25% ||
| 实验触发时机
 | 升级后首次进入「**Jaw**」
 | / ||
| 目标用户
