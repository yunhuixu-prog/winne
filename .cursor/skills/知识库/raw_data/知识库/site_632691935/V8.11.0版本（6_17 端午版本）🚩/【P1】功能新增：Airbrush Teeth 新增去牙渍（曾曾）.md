...
**路径**: V8.11.0版本（6_17 端午版本）🚩/【P1】功能新增：Airbrush Teeth 新增去牙渍（曾曾）

---

#### JIRA地址： [https://jira.meitu.com/browse/AIRBRUSH-7009?src=confmacro](AIRBRUSH-7009) - [https://cf.meitu.com/confluence/plugins/servlet/applinks/oauth/login-dance/authorize?applicationLinkID=37c0f303-b56f-3134-b610-d406e9dda7d5](认证) 查看问题详情
...
- 不固化，进入整牙或白牙功能打勾后，使用去牙渍，再次进入白牙/整牙仍可以调节，并记忆住上一次调节的参数
- 在teeth整个功能首页处打勾/打✖️退出牙齿页面以后则不记忆
...
- 用户若点击置灰按钮，则弹出toast"No teeth detected"，每次点击均弹出，2s渐隐消失
