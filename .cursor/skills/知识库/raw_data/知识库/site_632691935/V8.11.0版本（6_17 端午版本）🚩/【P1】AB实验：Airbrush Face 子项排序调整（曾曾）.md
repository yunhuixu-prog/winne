...
**路径**: V8.11.0版本（6_17 端午版本）🚩/【P1】AB实验：Airbrush Face 子项排序调整（曾曾）
...
| 对照组（线上） | width、cheekbone-s、lift、forehead、hairline、size、short、midface、lower face、philtrum、top、temples、Sculpt、****Tighten Pro**** | 33%
 ||
| Test A | **Tighten Pro**、**width、cheekbone-s、lift、Sculpt**、forehead、hairline、size、short、midface、lower face、philtrum、top、temples | 33% ||
