# 【P1】功能新增：Airbrush Face Head新增「畸变还原」功能（思思）

**页面ID**: 709003618

**路径**: V8.14.0版本（8_5上线）/【P1】功能新增：Airbrush Face Head新增「畸变还原」功能（思思）
...
- Airbrush-Face-Head-Undistort

功能排序：

- Horizontal、Vertical、Size、Undistort（第四位）
...
- 用户点击Undistort 功能和对比按钮高亮
- 开关：开、关
- 

其他：

- 首次进入Face-Head模块Undistort 增加小红点 **&middot; **用户点击后消失
- 名称前需要加星（Undistort ）
- 固化逻辑：打钩后固化
- 互斥/叠加逻辑：同线上
