...
**路径**: V8.5.0版本（3_25上线）/【P2】代码删除：Airbrush face 模糊画质优化实验（Jamie）
...
- Airbrushface 模糊画质优化实验，整体数据没有明确差异，可以依照业务需求全量。

- 考虑到由于实验组的画质在少数场景下效果更为稳定，因此本次已将实验组 B 全量，本次需求需删除相关实验代码。
