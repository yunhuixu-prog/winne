...
| 优惠组合类型 | 常态订阅周期 | 适用场景 | 测试SKU | AirBrush 英文文案 | 参数说明 ||
| 免费试用 + 一次性付款优惠 | 年 | N 天免费试用 + 首年优惠 | com.airbrush.subscription.test.vip1
7天试用+首年8折
 | Start with a %1$s-day free trial, then get your first year for %2$s. After that, %3$s/year. Cancel anytime. | %1$s = 免费试用天数；%2$s = 首年优惠价；%3$s = 常态年价 ||
| 免费试用 + 一次性付款优惠 | 月 | N 天免费试用 + 首月优惠 | com.airbrush.subscription.test.vip2
7天试用+首月8折
 | Start with a %1$s-day free trial, then get your first month for %2$s. After that, %3$s/month. Cancel anytime. | %1$s = 免费试用天数；%2$s = 首月优惠价；%3$s = 常态月价 ||
| 免费试用 + 一次性付款优惠 | 周 | N 天免费试用 + 首周优惠 | com.airbrush.subscription.test.vip3
7天试用+首周8折
 | Start with a %1$s-day free trial, then get your first week for %2$s. After that, %3$s/week. Cancel anytime. | %1$s = 免费试用天数；%2$s = 首周优惠价；%3$s = 常态周价 ||
| 免费试用 + 周期性付款优惠 | 年 | N 天免费试用 + 前 N 年优惠价 | com.airbrush.subscription.test.vip4
7天试用+首3年8折
 | Start with a %1$s-day free trial, then pay %2$s/year for the first %3$s year(s). After that, %4$s/year. Cancel anytime. | %1$s = 免费试用天数；%2$s = 优惠年价；%3$s = 优惠持续年数；%4$s = 常态年价 ||
| 免费试用 + 周期性付款优惠 | 月 | N 天免费试用 + 前 N 个月优惠价 | com.airbrush.subscription.test.vip5
7天试用+首3月8折
 | Start with a %1$s-day free trial, then pay %2$s/month for the first %3$s month(s). After that, %4$s/month. Cancel anytime. | %1$s = 免费试用天数；%2$s = 优惠月价；%3$s = 优惠持续月数；%4$s = 常态月价 ||
| 免费试用 + 周期性付款优惠 | 周 | N 天免费试用 + 前 N 周优惠价 | com.airbrush.subscription.test.vip6
7天试用+首3周8折
 | Start with a %1$s-day free trial, then pay %2$s/week for the first %3$s week(s). After that, %4$s/week. Cancel anytime. | %1$s = 免费试用天数；%2$s = 优惠周价；%3$s = 优惠持续周数；%4$s = 常态周价 ||
