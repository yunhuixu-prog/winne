# 【P1】效果新增：Airbrush Retouch效果新增（曾曾）

**页面ID**: 702256391

**路径**: V8.13.0版本（7_22上线）🚩/【P1】效果新增：Airbrush Retouch效果新增（曾曾）
...
**素材排序**
**Retouch：Natural、Smile、Cute、Dewy、Refine、Even、Delicate、Clean、Sculpted、Defined、Modle、Chiselled、Glowy**
****
**交互视觉**

- 角标：Retouch UI，2个新增素材，用户点击后消失
...
- 本期新增Dewy、Defined效果优化为素材中台动态下发配置（原先腮内缩、骨相还原为配置硬编码，上线、修改参数需要跟版）
...
- Dewy、Defined的曝光/点击/打勾/保存/订阅的UV/PV