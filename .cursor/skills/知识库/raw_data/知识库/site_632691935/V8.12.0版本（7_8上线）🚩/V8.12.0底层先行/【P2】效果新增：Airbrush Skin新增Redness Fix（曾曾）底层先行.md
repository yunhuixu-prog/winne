...
**路径**: V8.12.0版本（7_8上线）🚩/V8.12.0底层先行/【P2】效果新增：Airbrush Skin新增Redness Fix（曾曾）底层先行
...
- Redness上方新增New角标，用户点击后消失，New角标消失后展示限免角标，限免角标常驻，点击后不消失

**交互流程**

- 进入Skin，进入Redness Fix**，****进入三级页面，支持自动，手动，橡皮擦，默认自动（界面和交互方式follow smooth）
