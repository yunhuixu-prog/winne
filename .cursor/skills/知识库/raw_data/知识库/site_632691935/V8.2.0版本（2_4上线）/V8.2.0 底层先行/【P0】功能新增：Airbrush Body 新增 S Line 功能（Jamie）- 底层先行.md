...
**路径**: V8.2.0版本（2_4上线）/V8.2.0 底层先行/【P0】功能新增：Airbrush Body 新增 S Line 功能（Jamie）- 底层先行
...
- 用户进入【body】后，**在【瘦腰】的图标上方展示「小气泡」**
- 用户点击气泡，进入**【瘦腰】菜单内使用瘦腰功能**
- 气泡显示5s自动隐退
- 气泡展示内容，采用动态的方式
- 气泡文案：一键拥有 S 曲线，Get a Curvier S-Curve
...
| Takes 30s seconds,/n but worth it. | 花费30秒等待，/n但相当值得
 ||
