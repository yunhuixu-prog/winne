...
**路径**: V8.10.0版本（6_8上线）/v8.10.0代码删除/【P2】代码刪除：Airbrush Relight 动态缩略图 AAB 实验（Jamie）
...
## 一、需求背景
为了追求relight模块对应素材更好的进入转化，故对 relight 模块的缩略图交互进行体验实验，整体结论：

- **关键指标：实验组打勾率、保存绿指标可信下降 3%**
