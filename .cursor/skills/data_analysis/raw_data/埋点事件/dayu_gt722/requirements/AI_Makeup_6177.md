...
|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|
| 影响事件 | 0 | 1 | material_exposure | 素材曝光 | material_type | 素材类型 | 普通参数 | string |  | makeup |  |  | 素材曝光时触发 |  |  |  |
| 影响事件 | 0 | 1 | material_exposure | 素材曝光 | module | 模块 | 普通参数 | string |  |  |  |  | 素材曝光时触发 |  |  |  |
...
| 影响事件 | 0 | 1 | material_exposure | 素材曝光 | is_ai |  | 普通参数 | number | AI 1，非AI 0 |  |  |  | 素材曝光时触发 |  |  |  |
| 影响事件 | 0 | 1 | material_check | 素材打勾 | is_ai |  | 普通参数 | number | AI 1，非AI 0 |  |  |  | 应用功能时触发 |  |  |  |
...
| 影响事件 | 0 | 1 | material_check | 素材打勾 | material_type | 素材类型 | 普通参数 | string |  |  |  |  | 应用功能时触发 |  |  |  |
| 影响事件 | 0 | 1 | material_click | 素材点击 | is_ai |  | 普通参数 | number | AI 1，非AI 0 |  |  |  | 素材点击时触发 |  |  |  |
| 影响事件 | 0 | 1 | material_click | 素材点击 | material_type | 素材类型 | 普通参数 | string |  | makeup |  |  | 素材点击时触发 |  |  |  |
...
| 影响事件 | 0 | 1 | material_click | 素材点击 | module | 模块 | 普通参数 | string |  |  |  |  | 素材点击时触发 |  |  |  |
...
| 影响事件 | 0 | 1 | w_subscription_enter | 进入订阅页 | is_ai |  | 普通参数 | number | AI 1，非AI 0 |  |  |  | 成功订阅时上报成功付费时上报 |  |  |  |
...
| 影响事件 | 0 | 1 | w_subscription_click | 订阅页点击订阅按钮 | is_ai |  | 普通参数 | number | AI 1，非AI 0 |  |  |  | 选中某个plan并点击订阅按钮时上报 |  |  |  |
...
| 影响事件 | 0 | 1 | w_subscription_success | 订阅成功 | is_ai |  | 普通参数 | number | AI 1，非AI 0 |  |  |  | 进入订阅页时上报 |  |  |  |
...
| 新增事件参数值 | 0 | 1 | ai_func_use_result | 使用ai算法请求结果返回 | second_func | 二级功能参数 | 普通参数 | string |  | makeup |  |  | 使用ai算法请求结果返回时触发 |  |  |  |
| 影响事件 | 0 | 1 | ai_func_delivery | 请求ai算法 | first_func | 一级功能参数 | 普通参数 | string |  | retouch |  |  | 请求（是否拦截）的时候上报（缓存不报） |  |  |  |
| 新增事件参数值 | 0 | 1 | ai_func_delivery | 请求ai算法 | second_func | 二级功能参数 | 普通参数 | string |  | makeup |  |  | 请求（是否拦截）的时候上报（缓存不报） |  |  |  |
| 新增事件参数值 | 0 | 1 | cloudfilter_per_show | 图片云处理权限弹窗点击 | function | 功能 | 普通参数 | string |  | makeup |  |  |  |  |  |  |
| 新增事件参数值 | 0 | 1 | cloudfilter_per_show_ok | 图片云处理权限弹窗点击 | function |  | 普通参数 | string |  | makeup |  |  |  |  |  |  |