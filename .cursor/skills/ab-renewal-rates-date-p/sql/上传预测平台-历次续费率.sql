----续费率（skill 内副本；跑数前将三处日期改为当日 date_p=YYYYMMDD，与 app/ab新sdk/OKR 同步时可覆盖本文件）
...
from
        (select   contract_id
            ...
            WHERE date_p=20260518
                    ...
                    and pay_date between 20210101 and 20260518   -- 历史自 2021；上界与 date_p 一致
        )t1
