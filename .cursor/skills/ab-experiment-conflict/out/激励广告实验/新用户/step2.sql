...
FROM (
    ...
    FROM (
        ...
        FROM (
            ...
            WHERE date_p BETWEEN 20260428 AND 20260518
        ...
        JOIN (
            ...
            FROM (
                ...
                WHERE fa2.date_p BETWEEN 20260428 AND 20260511
            ) t
            WHERE ranks = 1
          AND enter_new = 1
        ) e
    ...
    FROM (
        ...
        where app_id_p IN (7329803307041000000)
            ...
            and is_subscribe = '订阅'
            and pay_date BETWEEN 20260428 AND 20260518
    ) p
    JOIN (
        SELECT gid, abcode, enter_abtest_date
        FROM (
            ...
            WHERE fa3.date_p BETWEEN 20260428 AND 20260511
        ) t3
        WHERE ranks = 1
          AND enter_new = 1
    ) e
